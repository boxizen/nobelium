...
export function HomeHeader() {
  ...
  return (
    <>
      <div className="observer-element flex h-4 md:h-12 items-center px-5 justify-between">
        <div className="flex items-center">
      ...
      <div className="flex-grow transition-all self-center px-4 w-full max-w-3xl">
        <Image
          className="mr-2 my-3"
          src={favicon}
          width={90}
